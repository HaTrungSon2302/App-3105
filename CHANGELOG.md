...
- Bundle-tree Patch workspace v2 under `On My iPhone/Tizi Mod/Patches`, synchronized automatically when applying or exporting.
...
- Limited wallpaper reset to active content installed by Tizi Mod.
